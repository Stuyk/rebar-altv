const hairOverlay: { [key: string]: { [key: string]: { collection: string; overlay: string } } } = {
    0: {
...
export function getHairOverlays(sex: 0 | 1) {
    return hairOverlay[sex];
}

export function getHairOverlay(sex: 0 | 1, style: number) {
    return hairOverlay[sex][style];
}
